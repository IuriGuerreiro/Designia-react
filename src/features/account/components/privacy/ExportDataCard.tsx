...
import { ReAuthDialog } from '@/features/auth/components/security/ReAuthDialog'
  ...
  return (
    <>
        ...
        <CardContent className="space-y-4">
          ...
          {isRequested ? (
            <AlertWithIcon variant="success" className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm mt-1">
                  We're preparing your data. You'll receive an email with a download link within
                  5-10 minutes.
                </p>
              </div>
            </AlertWithIcon>
            ...
            <div className="flex items-center gap-4">
              <Button onClick={handleOpenReAuth} disabled={isLoading} variant="outline">
                {isLoading ? (
      ...
      <ReAuthDialog
        ...
        title="Export Data Verification"
        description="Please confirm your password to request a full export of your personal data."
